...
public class WeatherUtils {
    private static String TIANQI_DAILY_WEATHER_URL = "http://api.seniverse.com/v3/weather/daily.json";

    private static String TIANQI_API_SECRET_KEY = "y8cug1ly0jplkx2h";

    private static String TIANQI_API_USER_ID = "U1731ED8A2";
    ...
    public static void main(String[] args){
        try {
            String url = WeatherUtils.generateGetDiaryWeather(
                    "210.46.108.102",
                    "zh-Hans",
                    "c",
                    "1",
